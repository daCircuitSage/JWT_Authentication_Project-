...
from accounts.serializers import UserRegistrationSerializer, UserLoginSerializer, UserProfileViewSrializer, UserChangePasswordSerializer, SendPasswordRestEmailSerializer, UserPassResetSerializer
